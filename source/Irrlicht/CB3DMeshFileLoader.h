...
private:
	...
	bool readChunkVRTS(CSkinnedMesh::SJoint* InJoint, CSkinnedMesh::SSkinMeshBuffer *MeshBuffer, s32 Vertices_Start);
	bool readChunkTRIS(CSkinnedMesh::SJoint* InJoint, CSkinnedMesh::SSkinMeshBuffer *MeshBuffer, u32 MeshBufferID, s32 Vertices_Start);
