There two tools available for creating fonts for irrlicht, both are supported.

oldFontTool:
	only works in Windows, creates a simple image file containint all data for displaying fonts.
...
newFontTool: 
	...
	different character sets, vector fonts and other operating systems then
